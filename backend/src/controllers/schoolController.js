...
const SCHOOL_EDITABLE_FIELDS = ['name', 'udise_code', 'village', 'city', 'district', 'taluka', 'pin_code', 'phone', 'email', 'medium', 'board', 'cert_header', 'cert_footer', 'cert_footer_line', 'principal_name', 'recog_no', 'class_from', 'class_to', 'school_section', 'lc_signature_label', 'bonafide_signature_label', 'sanstha_name', 'board_name', 'lc_show_photo'];
